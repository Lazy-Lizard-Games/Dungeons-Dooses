...
@export var health_maximum := Attribute.new(0, 0)
@export var health_regeneration := Attribute.new(0, 0)
@export var stamina_maximum := Attribute.new(0, 0)
@export var stamina_regeneration := Attribute.new(0, 0)
@export var movement_speed := Attribute.new(0, 0)
@export var movement_acceleration := Attribute.new(0, 0)
@export var movement_friction := Attribute.new(0, 0)
@export_category("Ability Stats")
@export var ability_power := Attribute.new(0, 0)
@export var ability_efficiency := Attribute.new(0, 0)
@export var ability_duration := Attribute.new(0, 0)
@export var ability_range := Attribute.new(0, 0)
@export var charge_rate := Attribute.new(0, 0)
@export var cast_rate := Attribute.new(0, 0)
@export var refresh_rate := Attribute.new(0, 0)
